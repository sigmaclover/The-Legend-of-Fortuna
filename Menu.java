...
final class Menu extends JFrame implements ActionListener{
	...
	private void initMenu() {
        ...
        { 
        	public void actionPerformed(ActionEvent e) {
        		...
        		Game game = new Game(1);//specifies first level is being run 
        ...
        { 
        	public void actionPerformed(ActionEvent e) {
        		...
        		Game game = new Game(2);//specifies second level is being run 
        		game.setVisible(true);
        		dispose();//closes the current window
        	}
        });
        ...
        { 
        	public void actionPerformed(ActionEvent e) {
        		...
        		Game game = new Game(3);//specifies third level is being run 
        		game.setVisible(true);
        		dispose();//closes the current window
        	}
        });
        ...
        { 
        	public void actionPerformed(ActionEvent e) {
        		...
        		Game game = new Game(4);//specifies third level is being run 
        		game.setVisible(true);
        		dispose();//closes the current window
        	}
        });
		...
		if (Menu.coins > 19 && armor == 0) {//if the player has more than 19 coins and no armor
			...
			//before the button has been clicked, Shop will display the back and buy blue armor buttons	
			shop.addActionListener(new ActionListener()  
		       { 
		       	public void actionPerformed(ActionEvent e) {
	                ...
	                buttons.removeAll();//removes buttons to prevent any overlap
			...
			//before the button has been clicked, Shop will display the back and buy red armor buttons	
			shop.addActionListener(new ActionListener()  
		       { 
		       	public void actionPerformed(ActionEvent e) {
		       		playback(1);
			...
			if (Menu.dress == 1) 
				buyD.setEnabled(false);
			//before the button has been clicked, Shop will display
			//the back and buy blue Princess armor buttons	
			shop.addActionListener(new ActionListener()  
		       { 
		       	public void actionPerformed(ActionEvent e) {
		       		playback(1);//changes the music to the Shop music
		...
		}else {//if the player does not have enough money to buy any armors or owns all the armors
			
			//does not add any buy buttons as there is nothing to buy
			shop.addActionListener(new ActionListener()  
	        { 
	        	public void actionPerformed(ActionEvent e) {
	        		playback(1);//changes the music to the Shop music
        ...
        { 
        	public void actionPerformed(ActionEvent e) {
        		...
        		myColor = Color.decode("#ceebfd");
                buttons.setBackground(myColor);	
                buttons.removeAll();//gtes rid of the buttons to prevent any overlap
	 ...
	 * 
	 */
	private void playback(int song) {
